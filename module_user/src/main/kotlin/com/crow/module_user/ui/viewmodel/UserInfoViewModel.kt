...
class UserInfoViewModel : BaseMviViewModel<UserIntent>() {
    ...
    fun setData(userInfo: LoginResultsOkResp) {
        mUserUpdateInfoData.add(R.drawable.user_ic_time_24dp to app.getString(R.string.user_datetime_created, userInfo.mDatetimeCreated.getDate()))
        mUserUpdateInfoData.add(baseR.drawable.base_ic_download_24dp to app.getString(R.string.user_download_count, userInfo.mDownloads.toString()))
        mUserUpdateInfoData.add(R.drawable.user_ic_email_24dp to app.getString(R.string.user_email, userInfo.mEmail.ifEmpty { "暂无" }))
    }

    fun setData(info: Info) {
        mUserUpdateInfoData.add(0, R.drawable.user_ic_gender_24dp to app.getString(R.string.user_gender, info.mGender.mDisplay))
        mUserUpdateInfoData.add(0, R.drawable.user_ic_usr_24dp to app.getString(R.string.user_username, info.mUsername))
        mUserUpdateInfoData.add(0, R.drawable.user_ic_usr_24dp to app.getString(R.string.user_nickname, info.mNickname))
    }
