 ...
 * @formatter:on
 */
class ComicCommentRvAdapter(
    private val mLifecycleScope: LifecycleCoroutineScope,
    private val onClick: (ComicCommentListResult) -> Unit
    ...
    class DiffCallback: DiffUtil.ItemCallback<ComicCommentListResult>() {
        override fun areItemsTheSame(oldItem: ComicCommentListResult, newItem: ComicCommentListResult): Boolean {
            return oldItem.mId == newItem.mId
        }

        override fun areContentsTheSame(oldItem: ComicCommentListResult, newItem: ComicCommentListResult): Boolean {
