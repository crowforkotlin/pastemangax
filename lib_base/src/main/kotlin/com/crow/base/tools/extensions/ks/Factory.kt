...
import com.crow.base.tools.extensions.ks.Serializer.FromBytes
import com.crow.base.tools.extensions.ks.Serializer.FromString
...
internal class Factory(
  ...
  override fun responseBodyConverter(
    ...
    return DeserializationStrategyConverter(serializer.serializer(type), serializer)
  }
  ...
  override fun requestBodyConverter(
    ...
    return SerializationStrategyConverter(contentType, serializer.serializer(type), serializer)
  }
}
